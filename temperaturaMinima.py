...
queryMysql = "SELECT HORA, DC_NOME, CD_ESTACAO, VL_LATITUDE, VL_LONGITUDE, TEM_MIN FROM dadosTratados where TEM_MIN = (select MIN(TEM_MIN) from dadosTratados where TEM_MIN IS NOT NULL) and createdAt >= '"+dataHoje[0:10]+" 03:00:00' and createdAt <= '"+dataAmanha[0:10]+" 02:59:59';"
