...
queryMysql = "select AVG(VEN_VEL) from dadosTratados where VEN_VEL IS NOT NULL and createdAt >= '"+dataHoje[0:10]+" 03:00:00' and createdAt <= '"+dataAmanha[0:10]+" 02:59:59';"
