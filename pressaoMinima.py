...
queryMysql = "SELECT HORA, DC_NOME, CD_ESTACAO, VL_LATITUDE, VL_LONGITUDE, PRE_MIN FROM dadosTratados where PRE_MIN = (select MIN(PRE_MIN) from dadosTratados where PRE_MIN IS NOT NULL) and createdAt >= '"+dataHoje[0:10]+" 03:00:00' and createdAt <= '"+dataAmanha[0:10]+" 02:59:59';"
